...
<PRE>
   ...
   244  replace_all_space
   245  replace_all_symbols
   246  replace_all_upper_case
   247  replace_back_slash_with_forward_slash
   248  replay_command
   249  retain_lines_from_to
   250  retrieve_ciphered_passcode
   251  retrieve_key_from_key_file
   252  retrieve_passcode
   253  run_01
   254  search_function
   255  see_file_with_line_range
   256  seed_random_with_pid
   257  seek
   258  seek_further
   259  set_entity_id
   260  set_terminal_title
   261  set_time_end
   262  set_time_start
   263  show_file_with_line_numbers
   264  show_latest_command_and_argument_history
   265  show_timestamp
   266  sign_file
   267  sign_file_base64_signature
   268  sign_file_dsa
   269  sign_file_ecc
   270  sign_file_rsa
   271  sign_file_with_cert
   272  sign_file_with_cert_dsa
   273  sign_file_with_cert_ecc
   274  sign_file_with_cert_rsa
   275  sign_message
   276  sign_message_dsa
   277  sign_message_ecc
   278  sign_message_rsa
   279  sign_message_with_cert
   280  sign_message_with_cert_dsa
   281  sign_message_with_cert_ecc
   282  sign_message_with_cert_rsa
   283  sign_with_rsa_pss
   284  sort_files_to_size
   285  sort_list
   286  status_last_execution
   287  string_to_array_with_single_char_delimiters
   288  string_to_array_with_single_pre_fixed_delimiters
   289  string_to_array_with_single_substring_delimiters
   290  test_font_display
   291  update_file_timestamp
   292  verify_file
   293  verify_file_dsa
   294  verify_file_ecc
   295  verify_file_rsa
   296  verify_file_with_cert
   297  verify_file_with_cert_dsa
   298  verify_file_with_cert_ecc
   299  verify_file_with_cert_rsa
   300  verify_message
   301  verify_message_dsa
   302  verify_message_ecc
   303  verify_message_rsa
   304  verify_message_with_cert
   305  verify_message_with_cert_dsa
   306  verify_message_with_cert_ecc
   307  verify_message_with_cert_rsa
   308  verify_signature_base64_signature
   309  verify_with_rsa_pss
   310  view_file_as_binary
   311  view_file_as_hex
   312  where_is_function
   313  word_count_in_str
   314  write_array_to_file
   315  write_ciphered_passcode_to_file
   316  write_passcode_plaintext_to_file
   317  zip_file
   318  zip_folder
